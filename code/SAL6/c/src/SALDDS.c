...
{
   char* typeName = SALData_SALTopicTypeSupport_get_type_name(typeSupport);

   g_status = SALData_SALTopicTypeSupport_register_type(typeSupport, domainParticipant, typeName);
   checkStatus(g_status, "SALData_SALTopicTypeSupport_register_type");
