...
public class SALResponseDataReaderImpl extends org.opensplice.dds.dcps.DataReaderImpl implements SALResponseDataReader
{
    private long copyCache;
    private SALResponseTypeSupport typeSupport;

    public SALResponseDataReaderImpl(SALData.SALResponseTypeSupport ts)
    {
        typeSupport = ts;
