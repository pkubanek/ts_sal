...
public class SALResponseTypeSupport extends org.opensplice.dds.dcps.TypeSupportImpl implements DDS.TypeSupportOperations
{
    private static java.lang.String idl_type_name = "SALData::SALResponse";
    private static java.lang.String idl_key_list = "";

    private long copyCache;

    public SALResponseTypeSupport()
    {
        super("SALData/SALResponseDataReaderImpl",
            "SALData/SALResponseDataReaderViewImpl",
            "SALData/SALResponseDataWriterImpl",
            "(LSALData/SALResponseTypeSupport;)V",
            "null",
            "null");
        ...
        try {
            success = org.opensplice.dds.dcps.FooTypeSupportImpl.Alloc(
                    ...
                    idl_type_name,
                    idl_key_list,
                    SALData.SALResponseMetaHolder.metaDescriptor);
        ...
        if (success == 0) {
            throw Utilities.createException(
                    ...
                    "Could not allocate SALResponseTypeSupport." );
        }
    }
