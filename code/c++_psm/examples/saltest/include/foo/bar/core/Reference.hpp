...
dds::core::Reference<DELEGATE>::Reference(dds::core::null_type&) : impl_(0)
{
...
template <typename DELEGATE>
bool
dds::core::Reference<DELEGATE>::operator!=(const null_type nil) const
{
    return !(this->is_nil());
}
