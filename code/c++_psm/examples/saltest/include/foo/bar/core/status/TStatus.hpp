...
/**
 * @file dds/core/status/TStatus.hpp
 */
...
template <typename D>
dds::core::policy::QosPolicyCountSeq& TOfferedIncompatibleQosStatus<D>::policies(dds::core::policy::QosPolicyCountSeq& dst) const
{
...
template <typename D>
dds::core::policy::QosPolicyCountSeq& TRequestedIncompatibleQosStatus<D>::policies(dds::core::policy::QosPolicyCountSeq& dst) const
{
    return this->delegate().policies(dst);
}
