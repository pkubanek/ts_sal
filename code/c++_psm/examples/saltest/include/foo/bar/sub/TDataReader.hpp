...
DataReader<T, DELEGATE>::DataReader(const dds::sub::Subscriber& sub,
                                    ...
                                    const dds::core::status::StatusMask& mask = ::dds::core::status::StatusMask::all()) : ::dds::core::TEntity< DELEGATE<T> >(new DELEGATE<T>(sub, topic, qos, new dds::sub::detail::EventHandler<DataReader, T>(*this, listener), mask))
{ }
...
{
    dds::sub::detail::EventHandler<DataReader, T>* h = new dds::sub::detail::EventHandler<DataReader, T>(*this, the_listener);
...
template <typename T, template <typename Q> class DELEGATE>
DataReader<T, DELEGATE>& DataReader<T, DELEGATE>::operator >> (dds::sub::qos::DataReaderQos& the_qos)
{
...
DataReader<T, DELEGATE>::liveliness_changed_status() const
{
...
DataReader<T, DELEGATE>::sample_rejected_status() const
{
...
DataReader<T, DELEGATE>::sample_lost_status() const
{
...
DataReader<T, DELEGATE>::requested_incompatible_qos_status() const
{
...
DataReader<T, DELEGATE>::subscription_matched_status() const
{
