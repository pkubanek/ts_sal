...
import org.apache.camel.component.dds.DdsExchange;
...
public class CamelDdsExchange implements Exchange {
    ...
    public CamelDdsExchange(CamelContext context) {
        this(context, ExchangePattern.InOnly);
    }

    public CamelDdsExchange(CamelContext context, ExchangePattern pattern) {
        this.context = context;
        this.pattern = pattern;
    }

    public CamelDdsExchange(Exchange parent) {
    ...
    public CamelDdsExchange(Endpoint fromEndpoint) {
        this(fromEndpoint, ExchangePattern.InOnly);
    }
    
    public CamelDdsExchange(Endpoint fromEndpoint, ExchangePattern pattern) {
        this(fromEndpoint.getCamelContext(), pattern);
        this.fromEndpoint = fromEndpoint;
    }

    public CamelDdsExchange(CamelContext context, ExchangePattern pattern, CamelDdsBinding binding) {
        this(context, pattern);
        this.binding = binding;
    }

    public CamelDdsExchange(CamelContext context, ExchangePattern pattern, CamelDdsBinding binding, CamelMessage msg) {
        this(context, pattern);
        this.binding = binding;
        setIn(new CamelDdsMessage(msg));
    }

    public CamelDdsExchange(Exchange parent, CamelDdsBinding binding) {
        this(parent);
        this.binding = binding;
    }
...
//    @Override
//    public DdsMessage getFault() {
//        return (DdsMessage) super.getFault();
//    }

//    @Override
//    protected DdsMessage createInMessage() {
//        return new DdsMessage();
//    }

    public CamelDdsBinding getBinding() {
        return binding;
    }

//    @Override
    public Exchange newInstance() {
        return new CamelDdsExchange(this, binding);
    }
