...
public class ContentFilteredTopic_Expr3Test extends ContextTestSupport {
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new RouteBuilder() {
            public void configure() throws Exception {
                // Chat.idl Filter expr: userID > 0 AND message = 'BB'
                String expr = "?contentFilter=userID%20%3E%200%20AND%20message%20%3D%20%27BB%27";
                from("direct:start").to("dds:T3:5/Chat.ChatMessage" + expr);
                from("dds:T3:5/Chat.ChatMessage" + expr).to("mock:result");
            }
        };
    }
}
