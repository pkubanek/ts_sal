...
/**
 * Use this implementation for SAL by defining the following:
 * -Dorg.omg.dds.serviceClassName=org.lsst.sal.SALBootStrap
 */
public class SALBootStrap extends Bootstrap {

    ServiceProvider serviceProvider = new ServiceProvider();
    SALDomainParticipantFactory factory = new SALDomainParticipantFactory(
            this);
