...
public class SALDataReader<TYPE> implements DataReader<TYPE> {

    final private SALTopic<TYPE> topic;
    final private SALSubscriber subscriber;
    ...
    private class SALDataAvailableStatus<TYPE> extends
        ...
        protected SALDataAvailableStatus(DataReader<TYPE> source) {
            super(source);
            drsource = source;
        }
        ...
        public DataAvailableStatus<TYPE> clone() {
            return new SALDataAvailableStatus<TYPE>(drsource);
        }

    }

    private class SALLivelinessChangedStatus<TYPE> extends
            LivelinessChangedStatus<TYPE> {
        private DataReader<TYPE> drsource;
        private DDS.LivelinessChangedStatus status;

        protected SALLivelinessChangedStatus(DataReader<TYPE> source,
        ...
        public LivelinessChangedStatus<TYPE> copyFrom(
            ...
            drsource = other.getSource();
            status = ((SALLivelinessChangedStatus) other).status;
            return this;
        }
        ...
        public LivelinessChangedStatus<TYPE> clone() {
            return new SALLivelinessChangedStatus<TYPE>(drsource, status);
        }
    }
    ...
    private class MyDataReaderListener implements DDS.DataReaderListener {
        ...
        final private SALDataReader<TYPE> reader;

        public MyDataReaderListener(SALDataReader<TYPE> thereader,
        ...
        public void on_data_available(DDS.DataReader arg0) {
            DataAvailableStatus<TYPE> status =
                    new SALDataAvailableStatus(reader);
        ...
        public void on_liveliness_changed(DDS.DataReader arg0,
            ...
            LivelinessChangedStatus<TYPE> status =
                    new SALLivelinessChangedStatus(reader, arg1);
    ...
    public SALDataReader(Bootstrap theBootstrap,
            TopicDescription<TYPE> theTopic, Subscriber theSubscriber) {
        bootstrap = theBootstrap;
        topic = (SALTopic<TYPE>) theTopic;
        subscriber = (SALSubscriber) theSubscriber;
        createReader();
    }
    ...
    public Iterator<TYPE> take() {
        ...
        try {
            ...
            SALSample.SampleIterator<TYPE> iterator =
                    new SALSample.SampleIterator<TYPE>(this, data, list,
                            sampleInfoHolder);
            return iterator;
        } catch (Exception e) {
        }
