...
public class SALDataWriter<TYPE> implements DataWriter<TYPE> {
    final private SALTopic<TYPE> topic;
    final private SALPublisher publisher;
    ...
    private SALDataWriterQos qos = null;

    public SALDataWriter(Bootstrap theBootstrap,
        ...
        publisher = (SALPublisher) thePublisher;
        if (theQos != null) {
            qos = (SALDataWriterQos) theQos;
        } else {
            qos = (SALDataWriterQos) publisher.getDefaultDataWriterQos();
        }
        createWriter();
    }
    ...
    public void setQos(DataWriterQos qos) {
        if (dataWriter != null) {
            dataWriter.set_qos(((SALDataWriterQos) qos).getQos());
        }
    }
