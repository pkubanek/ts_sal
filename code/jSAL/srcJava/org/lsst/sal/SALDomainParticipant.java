...
import org.lsst.sal.qos.SALTopicQos;
import org.lsst.sal.qos.policy.SALDomainParticipantQos;

public class SALDomainParticipant
    ...
    public SALDomainParticipant(Bootstrap thebootstrap,
    ...
    public DomainParticipantQos getQos() {
        ...
        return new SALDomainParticipantQos(holder.value);
    }

    @Override
    public void setQos(DomainParticipantQos qos) {
        openspliceParticipant.set_qos(((SALDomainParticipantQos) qos)
                .getQos());
    }
