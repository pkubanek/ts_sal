...
public class SALDomainParticipantFactory extends DomainParticipantFactory {
    private static int myDomain = DOMAIN_ID_DEFAULT.value;

    final private Bootstrap bootstrap;

    public SALDomainParticipantFactory(Bootstrap thebootstrap) {
    ...
    public DomainParticipant createParticipant(int domainId) {
        ...
        return new SALDomainParticipant(bootstrap, participant);
    }
