...
public class SALDuration extends ModifiableDuration {
    ...
    public SALDuration(Duration theduration) {
        durationNs = theduration.getDuration(TimeUnit.NANOSECONDS);
    }

    public SALDuration(DDS.Duration_t theduration) {
        durationDDS = theduration;
    }

    public SALDuration(long maxBlockingTime, TimeUnit unit) {
    ...
    public ModifiableDuration copyFrom(Duration other) {
        durationDDS = ((SALDuration) other).getDuration();
        return this;
    }
    ...
    public ModifiableDuration add(Duration duration) {
        durationNs = getNanosec()
                + ((SALDuration) duration).getNanosec();
        return this;
    }
    ...
    public ModifiableDuration clone() {
        return new SALDuration(getDuration());
    }
