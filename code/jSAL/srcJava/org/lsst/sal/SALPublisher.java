...
import org.lsst.sal.qos.SALDataWriterQos;
import org.lsst.sal.qos.SALPublisherQos;
...
public class SALPublisher implements Publisher {

    final private Bootstrap bootstrap;
    private DDS.Publisher publisher;
    private SALDomainParticipant participant;
    ...
    private class MyPublisherListener implements DDS.PublisherListener {
        ...
        private SALPublisher publisher;

        public MyPublisherListener(SALPublisher thepublisher,
    ...
    public SALPublisher(Bootstrap thebootstrap,
            DDS.Publisher thepublisher,
            SALDomainParticipant theparticipant) {
    ...
    public PublisherQos getQos() {
        ...
        return new SALPublisherQos(holder.value,
    ...
    public <TYPE> DataWriter<TYPE> createDataWriter(Topic<TYPE> topic) {
        DataWriter<TYPE> writer = new SALDataWriter<TYPE>(bootstrap,
                topic, this, null);
        return writer;
    }
    ...
    public DataWriterQos getDefaultDataWriterQos() {
        ...
        return new SALDataWriterQos(holder.value, bootstrap);
    }
