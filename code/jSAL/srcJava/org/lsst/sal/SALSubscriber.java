...
import org.lsst.sal.qos.SALDataReaderQos;

public class SALSubscriber implements org.omg.dds.sub.Subscriber {

    final private Bootstrap bootstrap;
    private DDS.Subscriber subscriber = null;
    private SubscriberListener thelistener = null;
    private SALDomainParticipant participant = null;
    private SubscriberQos theQos = null;

    public SALSubscriber(Bootstrap thebootstrap, DDS.Subscriber impl) {
    ...
    public <TYPE> DataReader<TYPE> createDataReader(TopicDescription<TYPE> topic) {
        DataReader<TYPE> reader = new SALDataReader<TYPE>(bootstrap,
                topic, this);
        return reader;
    }
    ...
    public DataReaderQos getDefaultDataReaderQos() {
        ...
        return new SALDataReaderQos(holder.value, bootstrap);
    }
