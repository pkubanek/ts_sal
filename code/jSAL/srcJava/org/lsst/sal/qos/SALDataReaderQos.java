...
public class SALDataReaderQos implements ModifiableDataReaderQos {

    private DDS.DataReaderQos qos;
    private Bootstrap bootStrap;

    public SALDataReaderQos(DDS.DataReaderQos theqos,
    ...
    public SALDataReaderQos clone() {
        return new SALDataReaderQos(qos, bootStrap);
    }

    @Override
    public ModifiableDataReaderQos copyFrom(DataReaderQos other) {
        bootStrap = (other.getBootstrap());
        qos = ((SALDataReaderQos) other).qos;
        return this;
    }
    ...
    public ModifiableDataReaderQos setLiveliness(LivelinessQosPolicy liveliness) {
        qos.liveliness =
                ((SALLivelinessQosPolicy) liveliness).getPolicy();
        return this;
    }
