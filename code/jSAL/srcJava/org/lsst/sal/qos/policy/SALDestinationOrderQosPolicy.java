...
public class SALDestinationOrderQosPolicy implements
    ...
    public SALDestinationOrderQosPolicy(
    ...
    public ModifiableDestinationOrderQosPolicy copyFrom(
        ...
        policy = ((SALDestinationOrderQosPolicy) other).policy;
        return this;
    }
    ...
    public SALDestinationOrderQosPolicy clone() {
        return new SALDestinationOrderQosPolicy(policy);
    }
}
