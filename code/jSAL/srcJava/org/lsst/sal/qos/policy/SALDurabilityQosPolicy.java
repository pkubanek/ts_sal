...
public class SALDurabilityQosPolicy implements
        ModifiableDurabilityQosPolicy {
    private DDS.DurabilityQosPolicy policy;

    public SALDurabilityQosPolicy(DDS.DurabilityQosPolicy thepolicy) {
        policy = thepolicy;
    }
    ...
    public ModifiableDurabilityQosPolicy copyFrom(DurabilityQosPolicy other) {
        policy = ((SALDurabilityQosPolicy) other).getPolicy();
        return this;
    }
    ...
    public SALDurabilityQosPolicy clone() {
        return new SALDurabilityQosPolicy(policy);
    }
