...
public class SALOwnershipStrengthQosPolicy implements
    ...
    public ModifiableOwnershipStrengthQosPolicy copyFrom(
        ...
        policy.value = ((SALOwnershipStrengthQosPolicy) other).policy.value;
        return this;
    }
    ...
    public ModifiableOwnershipStrengthQosPolicy clone() {
        return new SALOwnershipStrengthQosPolicy(policy);
    }
}
