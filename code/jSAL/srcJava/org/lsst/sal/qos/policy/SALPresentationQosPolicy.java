...
public class SALPresentationQosPolicy implements
        ModifiablePresentationQosPolicy {

    private DDS.PresentationQosPolicy policy;

    public SALPresentationQosPolicy(
    ...
    public ModifiablePresentationQosPolicy copyFrom(
        ...
        policy = ((SALPresentationQosPolicy) other).getPolicy();
        return this;
    }
    ...
    public SALPresentationQosPolicy clone() {
        return new SALPresentationQosPolicy(policy);
    }
}
