...
public class SALReliabilityQosPolicy implements
        ModifiableReliabilityQosPolicy {

    private DDS.ReliabilityQosPolicy policy;

    public SALReliabilityQosPolicy(DDS.ReliabilityQosPolicy thepolicy) {
        policy = thepolicy;
    }
    ...
    public ModifiableDuration getMaxBlockingTime() {
        return new SALDuration(policy.max_blocking_time);
    }

    public SALReliabilityQosPolicy clone() {
        return new SALReliabilityQosPolicy(policy);
    }

    @Override
    public ModifiableReliabilityQosPolicy copyFrom(
            ReliabilityQosPolicy other) {
        policy = ((SALReliabilityQosPolicy) other).getPolicy();
        return this;
    }
    ...
    public ModifiableReliabilityQosPolicy setMaxBlockingTime(
        ...
        policy.max_blocking_time = ((SALDuration) maxBlockingTime)
                .getDuration();
        return this;
    }
    ...
    public ModifiableReliabilityQosPolicy setMaxBlockingTime(
        ...
        SALDuration duration = new SALDuration(
