...
public class SALResourceLimitsQosPolicy implements
    ...
    public SALResourceLimitsQosPolicy(
    ...
    public ModifiableResourceLimitsQosPolicy copyFrom(
        ...
        policy = ((SALResourceLimitsQosPolicy) other).policy;
        return this;
    }
    ...
    public SALResourceLimitsQosPolicy clone() {
        return new SALResourceLimitsQosPolicy(policy);
    }
}
