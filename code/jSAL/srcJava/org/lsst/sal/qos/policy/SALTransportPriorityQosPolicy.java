...
public class SALTransportPriorityQosPolicy implements
        ModifiableTransportPriorityQosPolicy {

    private DDS.TransportPriorityQosPolicy policy;

    public SALTransportPriorityQosPolicy(
    ...
    public SALTransportPriorityQosPolicy clone() {
        return new SALTransportPriorityQosPolicy(policy);
    }
}
