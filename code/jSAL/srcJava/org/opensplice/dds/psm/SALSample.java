...
public class SALSample<TYPE> implements Sample<TYPE> {
    ...
    private SALSample(final TYPE value,
    ...
    public SALSample(DDS.SampleInfo sampleInfo, TYPE theValue) {
        value = theValue;
        ...
        time = new SALTime(sampleInfo.source_timestamp);
    ...
    public SALSample<TYPE> clone() {
        return new SALSample<TYPE>(
    ...
    public static class SampleIterator<TYPE> implements Iterator<TYPE> {
        ...
        public SampleIterator(SALDataReader<TYPE> theReader,
                Object dataList,
        ...
        public Sample<TYPE> next() {
            Sample<TYPE> sample = new SALSample<TYPE>(
