...
struct DataHandler {
  ...
  void handle_data(dds::DataReader<TopicId> reader) {
    TopicIdSeq samples;
  ...
  void handle_liveliness_change(dds::DataReader<TopicId>& reader, 
...
int main(int argc, char* argv[]) {
  ...
  boost::function<void (dds::DataReader<TopicId>)> func = 
