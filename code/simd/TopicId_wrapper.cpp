...
#define SWIGTYPE_p_uShortArray swig_types[1]
...
#define SWIG_init    Svcsal_topicid_Init
#define SWIG_name    "svcsal_topicid"
#define SWIG_prefix  ""
...
SWIGEXPORT int Svcsal_topicid_SafeInit(Tcl_Interp *interp) {
