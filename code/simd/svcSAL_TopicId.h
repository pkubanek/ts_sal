...
public:
	...
	svcRTN putSample ();
        ...
        svcRTN getItem ( svcIID itemId , svcSHORT value[] , svcUINT size );
        svcRTN getItem ( svcIID itemId , svcUSHORT value[], svcUINT size );
        svcRTN getItem ( svcIID itemId , svcINT value[] , svcUINT size );
        svcRTN getItem ( svcIID itemId , svcUINT value[], svcUINT size );
        svcRTN getItem ( svcIID itemId , svcLONG value[] , svcUINT size );
        svcRTN getItem ( svcIID itemId , svcULONG value[] , svcUINT size );
        svcRTN getItem ( svcIID itemId , svcFLT fvalue[], svcUINT size );
        svcRTN getItem ( svcIID itemId , svcDBL dvalue[], svcUINT size);
        ...
        svcRTN setItem ( svcIID itemId , svcSHORT value[] , svcUINT size );
        svcRTN setItem ( svcIID itemId , svcUSHORT value[], svcUINT size );
        svcRTN setItem ( svcIID itemId , svcINT value[] , svcUINT size );
        svcRTN setItem ( svcIID itemId , svcUINT value[], svcUINT size );
        svcRTN setItem ( svcIID itemId , svcLONG value[] , svcUINT size );
        svcRTN setItem ( svcIID itemId , svcULONG value[] , svcUINT size );
        svcRTN setItem ( svcIID itemId , svcFLT fvalue[], svcUINT size );
        svcRTN setItem ( svcIID itemId , svcDBL dvalue[], svcUINT size);
