...
public class SALCommandDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements SALCommandDataWriter
{
    private long copyCache;
    private SALCommandTypeSupport typeSupport;

    public SALCommandDataWriterImpl(SALData.SALCommandTypeSupport ts)
    {
        typeSupport = ts;
