...
public class SALEventTypeSupport extends org.opensplice.dds.dcps.TypeSupportImpl implements DDS.TypeSupportOperations
{
    private static java.lang.String idl_type_name = "SALData::SALEvent";
    private static java.lang.String idl_key_list = "";

    private long copyCache;

    public SALEventTypeSupport()
    {
        super("SALData/SALEventDataReaderImpl",
            "SALData/SALEventDataReaderViewImpl",
            "SALData/SALEventDataWriterImpl",
            "(LSALData/SALEventTypeSupport;)V",
            "null",
            "null");
        ...
        try {
            success = org.opensplice.dds.dcps.FooTypeSupportImpl.Alloc(
                    ...
                    idl_type_name,
                    idl_key_list,
                    SALData.SALEventMetaHolder.metaDescriptor);
        ...
        if (success == 0) {
            throw Utilities.createException(
                    ...
                    "Could not allocate SALEventTypeSupport." );
        }
    }
