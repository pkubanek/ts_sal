...
public class SALTopicDataReaderViewImpl extends org.opensplice.dds.dcps.DataReaderViewImpl implements SALTopicDataReaderView
{
    private long copyCache;
    private SALTopicTypeSupport typeSupport;

    public SALTopicDataReaderViewImpl(SALData.SALTopicTypeSupport ts)
    {
        typeSupport = ts;
