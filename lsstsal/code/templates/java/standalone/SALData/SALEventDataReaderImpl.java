...
public class SALEventDataReaderImpl extends org.opensplice.dds.dcps.DataReaderImpl implements SALEventDataReader
{
    private long copyCache;
    private SALEventTypeSupport typeSupport;

    public SALEventDataReaderImpl(SALData.SALEventTypeSupport ts)
    {
        typeSupport = ts;
