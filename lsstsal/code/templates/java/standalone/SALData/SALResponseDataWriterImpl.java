...
public class SALResponseDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements SALResponseDataWriter
{
    private long copyCache;
    private SALResponseTypeSupport typeSupport;

    public SALResponseDataWriterImpl(SALData.SALResponseTypeSupport ts)
    {
        typeSupport = ts;
