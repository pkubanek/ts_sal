...
public class SALTopicDataReaderImpl extends org.opensplice.dds.dcps.DataReaderImpl implements SALTopicDataReader
{
    private long copyCache;
    private SALTopicTypeSupport typeSupport;

    public SALTopicDataReaderImpl(SALData.SALTopicTypeSupport ts)
    {
        typeSupport = ts;
