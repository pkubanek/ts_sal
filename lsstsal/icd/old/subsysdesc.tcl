...
set DESC(environment.Dust.monitor) $DESC(environment.Dust_monitor)
set DESC(environment.Lightning.detector) $DESC(environment.Lightning_detector)
set DESC(environment.Video.cameras) $DESC(environment.Video_cameras)
