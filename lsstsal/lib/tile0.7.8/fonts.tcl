#
# fonts.tcl,v 1.11 2006/02/06 04:12:43 jenglish Exp
#
...
# TkFixedFont	-- standard fixed width font [not used in Tile]
# TkMenuFont	-- used for menu items [not used in Tile]
# TkCaptionFont	-- used for window and dialog caption bars [different in Tile]
# TkSmallCaptionFont -- captions on contained windows or tool dialogs [not used]
# TkIconFont	-- font in use for icon captions [not used in Tile]
# TkTooltipFont	-- font to use for tooltip windows
# 
#
# +++ Platform notes:
