...
# build directory.
TK_BUILD_LIB_SPEC='-L${LSST_SDK_INSTALL}/tk8.5.17/unix -ltk8.5'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L${LSST_SDK_INSTALL}/lib -ltk8.5'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I${LSST_SDK_INSTALL}/include'
...
# compiled.
TK_SRC_DIR='${LSST_SDK_INSTALL}/tk8.5.17'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L${LSST_SDK_INSTALL}/tk8.5.17/unix -ltkstub8.5'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L${LSST_SDK_INSTALL}/lib -ltkstub8.5'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='${LSST_SDK_INSTALL}/tk8.5.17/unix/libtkstub8.5.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='${LSST_SDK_INSTALL}/lib/libtkstub8.5.a'
