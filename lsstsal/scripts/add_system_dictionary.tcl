...
set SYSDIC(systems) "ATPtg atArchiver atcamera atHeaderService accl archiver atcs AtMCS AtPneumatics AtWhiteLightChiller AtWhiteLight AtDome AtHexapod atMonochromator atScheduler atWhiteLight calibrationCBP calibrationElectrometer calibrationMonochromator calibrationSpectrometer camera catchupArchiver comcam headerService dome domeADB domeAPS domeLouvers domeLWS domeMONCS domeTHCS eec efd environment EXA hexapod lasercal m1m3 m2ms MTMount MTPtg network ocs operations power promptProcessing rotator sedSpectrometer sequencer scheduler seeing Spectrograph skycam summitFacility system tcs tcsOfc tcsWEP vms"
