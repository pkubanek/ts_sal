    ...
    dev_proxy_ (0)
{
	...
	catch (SALLV::DevFailed &e) 
  {
    ...
    SALLV::Except::re_throw_exception(e,
                                      _CPTC("SALLV::DeviceProxy instanciation failed"),
			                                _CPTC(d.c_str()),
			                                _CPTC("DeviceDescriptor::DeviceDescriptor"));
	}
  catch (...) 
...
// DeviceDescriptor::DeviceDescriptor 
//=============================================================================
DeviceDescriptor::DeviceDescriptor (SALLV::DeviceProxy * _dp, bool _ownership)
  : dev_cmd_list_(0), 
    dev_attr_list_(0),
    dev_proxy_ (0)
{
...
//=============================================================================
void DeviceDescriptor::cmd_list (SALLV::CommandInfoList* _cmd_list)
{
  this->dev_cmd_list_.clear();
...
//=============================================================================
void DeviceDescriptor::attr_list (SALLV::AttributeInfoList* _attr_list)
{
  this->dev_attr_list_.clear();
