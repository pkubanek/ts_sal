...
public class SALCommandDataReaderViewImpl extends org.opensplice.dds.dcps.DataReaderViewImpl implements SALCommandDataReaderView
{
    private long copyCache;
    private SALCommandTypeSupport typeSupport;

    public SALCommandDataReaderViewImpl(SALData.SALCommandTypeSupport ts)
    {
        typeSupport = ts;
