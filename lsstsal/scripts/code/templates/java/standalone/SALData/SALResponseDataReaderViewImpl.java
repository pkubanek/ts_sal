...
public class SALResponseDataReaderViewImpl extends org.opensplice.dds.dcps.DataReaderViewImpl implements SALResponseDataReaderView
{
    private long copyCache;
    private SALResponseTypeSupport typeSupport;

    public SALResponseDataReaderViewImpl(SALData.SALResponseTypeSupport ts)
    {
        typeSupport = ts;
    ...
    public int read(
            SALData.SALResponseSeqHolder received_data, 
    ...
    public int read_next_sample(
            SALData.SALResponseHolder received_data, 
