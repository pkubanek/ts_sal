...
public class SALTopicDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements SALTopicDataWriter
{
    private long copyCache;
    private SALTopicTypeSupport typeSupport;

    public SALTopicDataWriterImpl(SALData.SALTopicTypeSupport ts)
    {
        typeSupport = ts;
